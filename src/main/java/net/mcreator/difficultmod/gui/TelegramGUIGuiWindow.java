...
@OnlyIn(Dist.CLIENT)
public class TelegramGUIGuiWindow extends ContainerScreen<TelegramGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = TelegramGUIGui.guistate;

	public TelegramGUIGuiWindow(TelegramGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
