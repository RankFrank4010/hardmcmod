...
import net.mcreator.difficultmod.gui.MyhuozhuiGuiWindow;
...
public class BagopenItem extends SuperdifficultmodModElements.ModElement {
	@ObjectHolder("superdifficultmod:bagopen")
	public static final Item block = null;

	public BagopenItem(SuperdifficultmodModElements instance) {
		super(instance, 42);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof MyhuozhuiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u6253\u5F00\u4F60\u7684\u4F19\u4F34\uFF08\u7D2F\u8D58\uFF1F\uFF09\u7684\u80CC\u5305"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("打开背包");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new MyhuozhuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
