...
import net.mcreator.difficultmod.gui.TelegramGUIGuiWindow;
import net.mcreator.difficultmod.gui.TelegramGUIGui;
...
public class TelegramtoolItem extends SuperdifficultmodModElements.ModElement {
	@ObjectHolder("superdifficultmod:telegramtool")
	public static final Item block = null;

	public TelegramtoolItem(SuperdifficultmodModElements instance) {
		super(instance, 39);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof TelegramGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Telegram is very safe."));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Telegram");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new TelegramGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
