...
package net.mcreator.difficultmod.world.biome;
...
import net.mcreator.difficultmod.block.DuYeBlock;
...
public class SiSiWangBiome extends SuperdifficultmodModElements.ModElement {
	public static Biome biome;

	public SiSiWangBiome(SuperdifficultmodModElements instance) {
		super(instance, 10);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3355444).setWaterColor(-16724788).setWaterFogColor(-3355444)
						.withSkyColor(-3355444).withFoliageColor(10387789).withGrassColor(-16737895).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.COBBLESTONE.getDefaultState(),
								DuYeBlock.block.getDefaultState(), Blocks.CRYING_OBSIDIAN.getDefaultState())));
				...
				biomeGenerationSettings
						.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
								Feature.TREE
										.withConfiguration(
												(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.SAND.getDefaultState()),
														new SimpleBlockStateProvider(Blocks.COAL_ORE.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("superdifficultmod:si_si_wang"));
			}
		}
	}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("si_si_wang_ctd");
